...
For verifying subscription status after checkout, see [JWT Authentication](https://docs.tributary.so/jwt-auth/index.md) — merchants validate signed JWTs client-side without needing Solana expertise.
...
- [REST API Reference](https://docs.tributary.so/api/rest-api/index.md) - Complete endpoint documentation
- [WebSocket API](https://docs.tributary.so/api/websocket/index.md) - Real-time notifications
- [Examples](https://docs.tributary.so/api/examples/index.md) - Code examples and use cases
