...
1. Smart contract verifies delegation scope (amount, time limits)
1. Payments execute automatically from user's token account
1. Users retain full custody and can revoke delegation anytime
...
| ----------------- | ------------------------------------------------ | --------------------------------------------------------------------------------- |
| **Subscription**  | Fixed recurring payments at regular intervals    | [Subscription Payments](https://docs.tributary.so/policies/subscription/index.md) |
| **Milestone**     | Project-based payments with up to 4 deliverables | [Milestone Payments](https://docs.tributary.so/policies/milestone/index.md)       |
| **Pay-as-you-go** | Usage-based billing with period limits           | [Pay-as-you-go Payments](https://docs.tributary.so/policies/payasyougo/index.md)  |
