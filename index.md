...
It simplifies the payments so that merchants can accept USDC without even thinking about blockchain specifics while still retaining the possibility to verify, not trust.
...
- **[Subscriptions](https://docs.tributary.so/policies/subscription/index.md)** - Fixed recurring payments (daily, weekly, monthly, etc.)
- **[Milestones](https://docs.tributary.so/policies/milestone/index.md)** - Project-based payments with up to 4 deliverables
- **[Pay-as-you-go](https://docs.tributary.so/policies/payasyougo/index.md)** - Usage-based billing with period limits
...
- [What is Tributary?](https://docs.tributary.so/what/index.md) - Understand the protocol
- [Integration](https://docs.tributary.so/integration/index.md) - Choose your integration method
- [SDK Reference](https://docs.tributary.so/sdk/index.md) - Complete SDK documentation
