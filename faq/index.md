...
Tributary is the non-custodial money-moving primitive on Solana: you delegate pull authority once — *set the riverbed once* — and money moves itself within rules you set. Pull, don't push. That single delegation replaces a thousand signatures and is what creates network effects through the provider ecosystem.

## Getting Started

### How do I integrate Tributary?

Check our [Integration Guide](https://docs.tributary.so/integration-guide/index.md) for SDK integration. The React components make it easy to add subscription buttons in minutes.
