...
1. **Policy Creation**: Flexible payment policies define when and how much to pay
1. **Automated Execution**: Smart contracts process payments according to the agreed schedule
1. **Direct Transfer**: Funds move directly from user token accounts to recipients
...
[Learn more about building providers →](https://docs.tributary.so/providers/index.md)
...
[Technical architecture details →](https://docs.tributary.so/architecture/index.md)
...
- [Protocol Architecture](https://docs.tributary.so/architecture/index.md) - Technical deep-dive
- [Use Cases](https://docs.tributary.so/use-cases/index.md) - Business applications
- [Payment Providers](https://docs.tributary.so/providers/index.md) - Building services
- [Why Tributary?](https://docs.tributary.so/why/index.md) - Problem & solution overview

Ready to get started? Choose your path above or [explore use cases →](https://docs.tributary.so/use-cases/index.md)
