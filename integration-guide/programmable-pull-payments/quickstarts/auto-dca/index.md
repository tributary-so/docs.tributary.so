...
This DCA runs unconditionally on schedule. To add a price guard (e.g. only buy SOL when price < $200), add a pre-validation Lighthouse assertion. See the [Lighthouse facade guide](https://docs.tributary.so/integration-guide/programmable-pull-payments/lighthouse-facade/index.md).
