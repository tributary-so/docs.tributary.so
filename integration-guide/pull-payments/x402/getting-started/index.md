...
- [x402 API Reference](https://docs.tributary.so/integration-guide/pull-payments/x402/api-reference/index.md)
- [Usage Metering](https://docs.tributary.so/integration-guide/pull-payments/x402/overview/#usage-metering)
- [Pay-as-you-go Payments](https://docs.tributary.so/protocol-reference/payment-policy/payasyougo/index.md)
