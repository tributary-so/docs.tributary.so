...
1. **Wallet Connection** prompts customer to connect their wallet
1. **Payment Confirmation** customer approves the subscription
1. **On-chain Subscription** created automatically on Solana
1. **Confirmation** customer receives confirmation and transaction signature
...
- **Explore Payment Types:** Learn about [subscriptions](https://docs.tributary.so/subscription-payments/index.md), [milestones](https://docs.tributary.so/milestone-payments/index.md), and [pay-as-you-go](https://docs.tributary.so/pay-as-you-go/index.md)
- **Monitor Payments:** Use the [SDK](https://docs.tributary.so/sdks/index.md) to track subscriptions and payments
- **Build with Lando:** Check out [Lando](https://lando.tributary.so) for AI-to-AI payments
- **Full SDK Reference:** See [SDKs](https://docs.tributary.so/sdks/index.md) for advanced usage

## Need Help?

- 📖 Read the full [SDK Reference](https://docs.tributary.so/sdks/index.md)
- ❓ Check our [FAQ](https://docs.tributary.so/faq/index.md)
